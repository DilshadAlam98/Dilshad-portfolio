...
String yourname = "I'm Dilshad Alam,";
...
String contactSubHeadding = "Let’s work together and make everything super cute and super useful.";
//
String miniDescription =
    "Let's team up and embark on a creative journey together. If you're seeking programming and design content services, I'm here to dive in and make things happen!";

String servicesSubHeading =
    "Since the beginning of my journey as a freelancer and developer, I've worked in startups and collaborated with talented people to create digital products for both business and consumer use. I offer a wide range of services, including brand design, programming and teaching.";
//
...
// const String aboutMeHeadline = 'I\'m Sudesh Bandara, a Mobile App developer, Web developer and UI designer.';
//
