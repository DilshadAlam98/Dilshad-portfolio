...
List<ProjectUtils> projectUtils = [
  ...
  ProjectUtils(
    ...
    description: 'This is a just CRM UI Design using Figma, file is also available, check below.',
  ...
  ProjectUtils(
    ...
    description: 'This is a just Plant App UI by using flutter, source code is also available, check below.',
